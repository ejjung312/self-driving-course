...
from project3_vehicle_detection.functions_detection import *
from project3_vehicle_detection.functions_utils import normalize_image
from project3_vehicle_detection.functions_feat_extraction import find_cars

time_window = 5
hot_windows_history = collections.deque(maxlen=time_window)

# load pretrained svm classifier
svc = pickle.load(open('project3_vehicle_detection/data/svm_trained.pickle', 'rb'))

# load feature scaler fitted on training data
feature_scaler = pickle.load(open('project3_vehicle_detection/data/feature_scaler.pickle', 'rb'))

# load parameters used to perform feature extraction
feat_extraction_params = pickle.load(open('project3_vehicle_detection/data/feat_extraction_params.pickle', 'rb'))
...
if __name__ == '__main__':
    ...
    for test_img in os.listdir(test_img_dir):
        ...
        cv2.imwrite('project3_vehicle_detection/output_images/{}'.format(test_img), frame_out)
