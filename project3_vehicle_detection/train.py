...
from project3_vehicle_detection.config import root_data_non_vehicle, root_data_vehicle, feat_extraction_params
# from functions_detection import draw_boxes
from project3_vehicle_detection.functions_detection import search_windows, slide_window, draw_boxes
from project3_vehicle_detection.functions_feat_extraction import extract_features_from_file_list
from project3_vehicle_detection.project_5_utils import get_file_list_recursively
...
if __name__ == '__main__':
    ...
    with open('project3_vehicle_detection/data/svm_trained.pickle', 'wb') as f:
        pickle.dump(svc, f)
    with open('project3_vehicle_detection/data/feature_scaler.pickle', 'wb') as f:
        pickle.dump(feature_scaler, f)
    with open('project3_vehicle_detection/data/feat_extraction_params.pickle', 'wb') as f:
        pickle.dump(feat_extraction_params, f)

    # test on images in "test_images" directory
    test_img_dir = "project3_vehicle_detection/test_images"
