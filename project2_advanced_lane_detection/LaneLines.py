...
class LaneLines:
    ...
    def __init__(self):
        ...
        self.dir = []
        self.left_curve_img = mpimg.imread('project2_advanced_lane_detection/left_turn.png')
        self.right_curve_img = mpimg.imread('project2_advanced_lane_detection/right_turn.png')
        self.keep_straight_img = mpimg.imread('project2_advanced_lane_detection/straight.png')
